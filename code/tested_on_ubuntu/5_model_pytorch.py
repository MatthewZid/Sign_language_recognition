...
class MattLandmarkDataset(Dataset):
...
def main():
    ...
    train = MattLandmarkDataset(train_set_path, train_landm_csvs_path)
    val = MattLandmarkDataset(val_set_path, val_landm_csvs_path)
